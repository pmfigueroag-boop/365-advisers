    ...
    return (
        <div className={`glass-card p-5 border-[#30363d] ${className}`}>
            <div className="flex items-center gap-2 mb-4">
                ...
                <InfoTooltip text="Quick view of key risk metrics: overall level, crowding, volatility, and position size adjustment." position="bottom">
            ...
            <div className="space-y-3">
                ...
                {riskLevel && (
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-1.5">
                            ...
                            <InfoTooltip text="Overall risk classification based on volatility, opportunity score, and market conditions." showIcon={false}>
                ...
                {crowdingLevel && (
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-1.5">
                            ...
                            <InfoTooltip text="Position concentration indicator. If many investors hold the same position, the risk of sharp moves increases." showIcon={false}>
                ...
                {atrPct != null && (
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-1.5">
                            ...
                            <InfoTooltip text="Average True Range (ATR) as a percentage of price. Measures expected daily volatility. >3% = high volatility." showIcon={false}>
                ...
                {positionSizing?.risk_adjustment != null && (
                    <div className="flex items-center justify-between">
                        <InfoTooltip text="Adjustment applied to position size based on risk. Negative = position reduced due to high risk. Positive = increased due to low risk." showIcon={false}>
